...
then
  ...
  JAVA_OPTS="-Xms${PAPERMC_PROJECT_RAM} -Xmx${PAPERMC_PROJECT_RAM} -XX:+UseG1GC -XX:G1HeapRegionSize=4M -XX:+UnlockExperimentalVMOptions -XX:+ParallelRefProcEnabled -XX:+AlwaysPreTouch"
fi
